...
class TestWorkAHomework(unittest.TestCase):
    ...
    def test_making_hw(self):
        ...
        ***The user is returned to the dashboard and the completed homework shows X/X answered in the dashboard progress column (t1.71.15)***
        ...
        # course_number = "227"
        # assignment_name = "hw no.40: 2017-06-16"
        ...
        while(True):
            try:
                ...
                sections[count].click()
        #
        # # t1.71.08 --> currently this test might not always work
        ...
        # element = self.wait.until(expect.visibility_of_element_located((By.XPATH,
        #     '//input[contains(@id,"option") and '
        #     'contains(@id,"%s")]' % str(answer_ind)))
        #     )
        # print('found multiple choice answer 1')
        ...
        # T1.71.11 - this is supposed to answer all the questions
        ...
        # T1.71.16 - A homework may have a Review assessment.
        ...
        ### t1.71.16 -- HOW DO YOU CHECK FOR REVIEW ASSIGNMENT?

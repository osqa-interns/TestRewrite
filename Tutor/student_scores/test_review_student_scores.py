...
-the way it is there might not be any assignments to look at under student scores
-how are we going to ensure that there are?
-do we just have to test on teachers whose students have worked assignments?
-or do we automate the work ourselves to ensure that there is data to work with?
...
class TestViewClassScores(unittest.TestCase):
    ...
    def test_review_student_scores(self):
        ...
        ***The user is presented with scores at due date (t2.10.06)***
        ...
        Click on the orange flag in the upper right corner of a progress cell for the desired student
        ...
        ***Performance Forecast for second selected student is displayed (t1.23.06)***
        ...
        ***Students are sorted by completion of selected assignment. (t1.23.10)***

        Click on the tab for selected section
        ***Due date for selected assignment is displayed in the cell below the assignment name (t1.23.011)***
        ...
        while (bar < scroll_total_size):
            try:
                ...
                late_caret.click()
                pie_progress = late_caret.findElement(By.XPATH,"/..//svg[contains(@class,'pie-progress')]")
        ...
        self.teacher.wait.until(expect.presence_of_element_located((By.XPATH,
            '//span[contains(text(), "Performance Forecast for")]')))


        # (t1.23.06) --> Performance Forecast for second selected student is displayed
        ...
        self.teacher.find(
            By.XPATH,
            '//div[contains(@class,"header-row")]' +  ### WATCH OUT-- THERE'S MULTIPLE HEADER-CELLS
            '//div[contains(@class,"is-descending")]')

        # self.teacher.find(
        #     By.XPATH, '//div[contains(text(),"Name and Student ID")]').click() ##
        #
        #
        # self.teacher.find(
        #     By.XPATH,
        ...
        # t1.23.10 --> Students are sorted by completion of selected assignment.
        ...
        assignment_cell.find_element(By.XPATH, '//following-sibling::div[contains(@class,"due")]')

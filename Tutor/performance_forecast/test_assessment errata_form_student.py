...
### IN THE CASE THAT CLICKING THE ERRATA LINK OPENS UP A NEW WINDOW, YOU CAN
    ...
    def test_assessment_errata_form(self):
        ...
        ***The user is taken to the Assessment Errata Form and the ID is prefilled.(t1.55.11)***

        Fill out the fields
        Click the 'Submit' button
        ***The form is submitted and the message that says "Your response has been recorded" is displayed (t1.55.12)***

        Corresponds to...
        t1.55.11,12
        '''
        # Test steps and verification assertions
        # t1.55.11 --> The user is taken to the Assessment Errata Form and the ID is prefilled

...
class TestPractice(unittest.TestCase):
    ...
    def test_performance_practice_student(self):
        ...
        Enter the student user account [ student01 | password ] in the username and password text boxes
        ...
        ***The header bar, containing the course name, OpenStax logo, and user menu link are visible. (t1.55.03)***

        Click a breadcrumb
        ***The student is taken to a different question in the practice session. (t1.55.02)***
        ...
        ***The answer is submitted and the 'Next Question' button appears. (t1.55.07)***
        ***The answer is submitted, the correct answer is displayed, and feedback on the answer is given. (t1.55.08)***
        ***The correctness for the completed question is visible in the breadcrumb. (t1.55.09)***

        Navigate through each question in the assessment and Answer the assessments
        ***Each question's identification number and version are visible. (t1.55.10)***
        ***End of practice shows the number of assessments answered (t1.55.13)***
        ...
        ***The user is returned to the dashboard (t1.55.14)***
        ...
        ### NOT SURE WHICH COURSE WE SHOULD USE --> DO WE USE ONE COURSE WHICH WE ASSUME THE STUDENT HAS?
        ### YOU REALLY CAN'T USE JUST ANY COURSE EITHER --> IT HAS TO HAVE SUFFICIENT QUESITONS ANSWERED
        ### AS TO ALLOW FOR PRACTICE

        # self.student.goto_performance_forecast()

        # Go to practice
        practice_text = self.student.find(By.XPATH,"//div[contains(text(),'Practice more')]")
        ### SHOULD WE ADD COMMAND  TO SCROLL TO THIS?
        practice_text.click()
        self.student.driver.wait(20) ### practice exercises take a realllly long time to load
        self.wait.until(expect.visibility_of_element_located((
        By.XPATH,"//div[contains(@class,'card-body')]"))
        )

        #t1.55.03 --> The header bar, containing the course name, OpenStax logo, and user menu link are visible
        navbar = self.student.find(By.XPATH,"//nav[contains(@class,'navbar')]")
        # OS logo
        ...
        ### DO WE NEED THIS PIECE OF CODE TO SEND KEYS? IT SEEMS THAT WE'RE DOING THIS LATER
        ...
        # t1.55.02 --> The student is taken to a different question in the practice session.
        ...
        # t1.55.05 --> The text box disappears and the multiple choice answer appear
        self.student.find(
            By.XPATH,
        ...
        # t1.55.07 --> The answer is submitted and the 'Next Question' button appears
        submit_btn.click()
        self.wait.until(
        ...
        # t1.55.08 -->The answer is submitted, the correct answer is displayed, and feedback on the answer is given
        self.wait.until(
            expect.visibility_of_element_located(
        ...
        # t1.55.09 --> The correctness for the completed question is visible in the breadcrumb
        self.wait.until(
            expect.visibility_of_element_located(
                (By.XPATH,
        ...
        # t1.55.10 --> Each question's identification number and version are visible

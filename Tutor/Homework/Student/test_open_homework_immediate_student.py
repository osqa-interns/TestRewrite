...
Needs to use the current_tutor_term helper function in supplementary_functions.py
Set it up so that it can use that function without having to keep the function in the same doc as I did below
Once you do that, you can delete the current_tutor_term() function (the original is stored in supplementary_functions.py)
...
class TestWorkAHomework(unittest.TestCase):
    ...
    def test_teacher_make_homework_immediate(self):
        ...
        Click on a homework assignment (with immediate feedback) on the list dashboard
        ...
        ***Answer feedback is presented
        ...
        open_course_xpath = '//div[contains(@data-title,"{0}") and contains(@data-term,"{1}")]//a'.format(
        ...
        homework = self.student.find(By.XPATH,

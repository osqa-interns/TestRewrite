...
class TestWorkAReading(unittest.TestCase):
    ...
    def test_start_reading_assignment_student(self):
        ...
        Enter the student user account [ student04 | password ] in the username and password text boxes
        ...
        ***The user returns to dashboard and the reading is marked "In Progress" in the dashboard progress column (t1.28.21)***

...
class TestViewClassScores(unittest.TestCase):
    ...
    def TestReadingAssignments(self):
        ...
        ***Displays students progress on chosen assignment for selected period, actual questions, and question results. (t1.23.12)***
        ***Complete, In Progress, and Not Started counts for selected period are displayed (t1.23.19)***
        ...
        ***List of student text responses for selected question is displayed. (t1.23.22)***
        ...
        ***Teacher view of student work shown. Teacher can go through different sections with side arrows or breadcrumbs. Only sections student has gone through are shown. (t1.23.24)***
        ...
        ***Corresponds to***
        ...
        # t1.23.19 --> Complete, In Progress, and Not Started counts for selected period are displayed
        self.teacher.wait.until(
            expect.visibility_of_element_located(
                (By.XPATH,
        ...
        # Spaced Practice Performance section numbers match the section breadcrumbs
...
### ALMOST SURE THAT 23 IS A SUBCASE OF 19 -- VERIFY
        ...
        # t1.23.22 -->List of student text responses for selected question is displayed
        ...
        #t1.23.24 -->
        ### LOOKING BACK AT THIS CODE, I'M NOT SURE WHAT THIS ELEMNET IS SUPPOSED TO BE
        element.click()
        actions = ActionChains(self.teacher.driver)

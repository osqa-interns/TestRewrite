...
class TestManageEcosystems(unittest.TestCase):
    ...
    def test_content_tag_search_admin(self):
        ...
        ***The user is returned to the Tags page and the text 'The tag has been updated.' is displayed. (t1.58.20)***
        :return:
        ...
        # (t1.58.20) --> The user is returned to the Tags page and the text 'The tag has been updated.' is displayed.

...
Test code from corresponding cases copied over  from t1.58 and reworked together
...
"""
    ...
    def test_course_offering_admin(self):
        ...
        ***The user is returned to the Catalog Offerings page and the text 'The offering has been created.' is displayed.(t1.58.01)***

        Click the 'Edit' link for the desired course
        Edit the text in the 'Salesforce book name' text box
        Click the 'Save' button
        ***The Catalog Offerings page is reloaded with the changes visible and the text 'The offering has been updated.' is visible. (t1.58.02)***

        Click the 'Edit' link for the desired course
        Select a different option in the 'Ecosystem' drop down menu
        Click the 'Save' button
        ***The Catalog Offerings page is reloaded with the changes visible and the text 'The offering has been updated.' is visible. (t1.58.03)***

        Click the 'Edit' link for the desired course
        Edit the checkboxes for 'Works for full Tutor?' and 'Works for Concept Coach?'
        Click the 'Save' button
        ***The user is returned to the Catalog Offerings page with the changes visible. The text 'The offering has been updated.' is visible. (t1.58.04)***

        Click the 'Edit' link for the desired course
        Edit the text in the 'Pdf url' text box
        Edit the text in the 'Webview url' text box
        Click the 'Save' button
        ***The user is returned to the Catalog Offerings page with the changes visible. The text 'The offering has been updated.' is visible. (t1.58.05)***

        Click the 'Edit' link for the desired course
        Edit the text in the 'Default course name' text box
        Click the 'Save' button
        ***The user is returned to the Catalog Offerings page with the changes visible. The text 'The offering has been updated.' is visible. (t1.58.06)***

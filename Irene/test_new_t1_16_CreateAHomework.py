...
class TestCreateHomework(unittest.TestCase):
    ...
    # Case C316 - Teacher | Show available problems
    ...
    def test_select_problems_including_tutor_selection(self):
        ...
        # self.teacher.wait.until(
        #     expect.element_to_be_clickable(
        #         (By.XPATH, '//div[@class="selected-mask"]/..//div[contains(@class, "exclude")]')
        #     )
        # ).click()
    ...
    # Case C318 - Teacher | Preview feedback and report error
    ...
    def test_cancel_assessment_selection_after_changes(self):
        ...
        cancel = self.teacher.find(
            By.XPATH, '//button[contains(@class,"show-problems")]/..//button[text()="Cancel"]'
        )
        ...
        x_button = self.teacher.find(
            By.XPATH,
            '//span[contains(text(),"Add Questions")]/..//button[contains(@class,"close-x")]'
        )
        self.teacher.scroll_to(x_button)
        sleep(1)
        x_button.click()
    ...
    def test_view_and_reorder_problems(self):
        ...
        (The ordering of the problems changes and the Problem Question list reflects the change the problem ordering.)

...
class TestCreateAnExternalAssignment(unittest.TestCase):
    ...
    # Case C146489 001 - Teacher | Add a new open external assignment for all periods
    @pytest.mark.skipif(str(146489) not in TESTS, reason='Excluded')
    def test_teacher_add_a_new_open_external_assignment_all_periods_146489(self):
        """
        ...
        Type or select today's date for the assignment using the calendar element
        Type 00:00am as the the open time for the assignment using the calendar element
        Type or select a due date in the future for the assignment using the calendar element
        Enter an assignment URL to the 'Assignment URL' text box
        Click "Publish"

        Expected result:
        Takes user back to calendar dashboard.
        An open external assignment appears on user calendar dashboard on due date.
        """
        self.ps.test_updates['name'] = 'tutor_external_teacher' \
                                       + inspect.currentframe().f_code.co_name[
                                         4:]
        self.ps.test_updates['tags'] = ['tutor', 'external', 'teacher', '146489']
    ...
    # Case C146490 002 - Teacher | Save a draft external assignment for individual periods
    @pytest.mark.skipif(str(146490) not in TESTS, reason='Excluded')
    def test_teacher_save_a_draft_external_assignment_individual_periods_146490(self):
        """
        ...
        Type in or select open and due dates for each period using the calendar element
        ...
        Expected result:
        Takes user back to calendar dashboard.
        Assignment appears on user calendar dashboard on due date. 'draft' should appear before the assignment name.
        """
        self.ps.test_updates['name'] = 'tutor_external_teacher' \
                                       + inspect.currentframe().f_code.co_name[
                                         4:]
    ...
    # Case C146491 003 - Teacher | Add a new unopened external assignment from calendar
    @pytest.mark.skipif(str(146491) not in TESTS, reason='Excluded')
    def test_teacher_add_a_new_unopened_external_assignment_calendar_146491(self):
        """
        ...
        Select the 'All Periods' radio button if it is not selected by default]
        Type or select an open date in the future for the assignment using the calendar element
        Type or select a due date in the future for the assignment using the calendar element
        ...
        Expected result:
        Takes user back to calendar dashboard.
        An unopened external assignment appears on user calendar dashboard on due date.
        """
        self.ps.test_updates['name'] = 'tutor_external_teacher' \
                                       + inspect.currentframe().f_code.co_name[
                                         4:]
    ...
    # Case C146493 005 - Teacher | Cancel a new external assignment before changes
    @pytest.mark.skipif(str(146493) not in TESTS, reason='Excluded')
    def test_teacher_cancel_a_new_external_assignment_before_changes_146493(self):
        """
    ...
    # Case C146494 006 - Teacher | Cancel a new external assignment after changes
    @pytest.mark.skipif(str(146494) not in TESTS, reason='Excluded')
    def test_teacher_cancel_a_new_external_assignment_after_changes_146494(self):
        """
    ...
    # Case C146495 007 - Teacher | Cancel a draft external assignment before changes
    @pytest.mark.skipif(str(146495) not in TESTS, reason='Excluded')
    def test_teacher_cancel_a_draft_external_assignment_before_changes_146495(self):
        """
    ...
    # Case C146496 008 - Teacher | Cancel a draft external assignment after changes
    @pytest.mark.skipif(str(146496) not in TESTS, reason='Excluded')
    def test_teacher_cancel_a_draft_external_assignment_after_changes_146496(self):
        """
    ...
    # Case C146497 009 - Teacher | Attempt to save/publish an external assignment with blank required fields
    @pytest.mark.skipif(str(146497) not in TESTS, reason='Excluded')
    def test_teacher_attempt_to_publish_or_save_with_blank_required_fields_146497(self):
        """
        Attempt to save or publish an external assignment with blank required fields

        Steps:
        Click on the 'Add Assignment' menu
        Click on the 'Add External Assignment' option
        Click on the 'Publish' button
        (Remains on the Add External Assignment page. Does not allow user to publish assignments. All required fields that were left blank become red, and specify that they are required fields.)

        Refresh the browser
        Click on the 'Save As Draft' button

        Expected result:
        Remains on the Add External Assignment page. Does not allow user to save assignments.
    ...
    def test_teacher_delete_an_open_external_assignment_146500(self):
        ...
        assert len(deleted_unopened) == 0, 'open external assignment not deleted'
    ...
    def test_teacher_change_a_draft_external_assignment_146501(self):
        ...
        Click on the Open Date text field, and click on a new Open Date on the calendar
        Click on the Due Date text field and click on a new Due Date on the calendar
        Enter a new assignment URL into the Assignment URL text
        Click the 'Save As Draft' button

        Expected result:
        Takes user back to the calendar dashboard.
        The name, description, due dates, and assignment URL of the external assignment have been updated.
        The draft external assignment now appears on its new due date on the calendar.
        """
        self.ps.test_updates['name'] = 'tutor_external_teacher' \
                                       + inspect.currentframe().f_code.co_name[
                                         4:]
    ...
    def test_teacher_change_an_unopened_external_assignment_146502(self):
        ...
        The name, description, due dates, and assignment URL of the external assignment have been updated.
        The external assignment now appears on its new due date on the calendar.
        """
        self.ps.test_updates['name'] = 'tutor_external_teacher' \
                                       + inspect.currentframe().f_code.co_name[
                                         4:]
    ...
    def test_teacher_change_an_open_external_assignment_146503(self):
        ...
        Expected result:
        Takes user back to the calendar dashboard.
        The name, description and due dates of the external assignment have been updated.
        The external assignment now appears on its new due date on the calendar.
        """
        self.ps.test_updates['name'] = 'tutor_external_teacher' \
                                       + inspect.currentframe().f_code.co_name[
    ...
    # Case C146504 016 - Teacher | Add an external assignment by dragging and dropping
